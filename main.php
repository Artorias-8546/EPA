    ...
    <div class="container-inputs" >
        <div class="quadrado-shadow">
            ...
            <label for="t-button" class="tooltip1" id="t-label">
                <img src="img/perda_de_peso.png" alt="" width ="230vh" class = "img1m">
            ...
            <img src="img/fortalecimento_abdominal.png" alt="" width ="135vh" class = "img2m">
                <span class="mensagem1">Fortalecimento abdominal</span>
            </label>
            </div>
            <div class="quadrado-shadow">
            <input type="checkbox" id="t-button3" class="input-t">
            <label for="t-button3" class="tooltip1" id="t-label3">
            <img src="img/manter_a_forma2.gif" alt="" width ="135vh" class = "img3m">
            ...
            <img src="img/treino_de_panturrilha.png" alt="" width ="135vh" class = "img4m"> 
                <span class="mensagem1">Treino de panturrilha</span>
            </label>
            </div>
            <div class="quadrado-shadow">
            <input type="checkbox" id="t-button5" class="input-t">
            <label for="t-button5" class="tooltip1" id="t-label5">
            <img src="img/treino_de_antebraco.png" alt="" width ="135vh" class = "img5m">
            ...
            <img src="img/equilibrio_do_corpo.png" alt="" width ="135vh" class = "img6m">
            ...
            <img src="img/desenvolvimento_de_biceps.png" alt="" width ="150vh" class = "img7m">
                <span class="mensagem1">Desenvolver bíceps</span>
            </label>
            </div>
            <div class="quadrado-shadow">
            <input type="checkbox" id="t-button8" class="input-t">
            <label for="t-button8" class="tooltip1" id="t-label8">
            <img src="img/treino_de_trapezio2.png" alt="" width ="135vh" class = "img8m">
            ...
            <img src="img/aliviacao_dores_musculares.png" alt="" width ="140vh" class = "img9m">
            ...
            <img src="img/fortalecimento_da_coluna001.png" alt="" width ="135vh" class = "img10m">
            ...
            <img src="img/treino_de_torax.gif" alt="" width ="155vh" class = "img11m">
            ...
            <img src="img/flexibilidade2.gif" alt="" width ="180vh" class = "img12m">
            ...
            <img src="img/treino_de_perna.png" alt="" width ="135vh" class = "img13m">
            ...
            <img src="img/cintura.png" alt="" width ="155vh"class = "img14m" >
            ...
            <img src="img/treino_de_triceps.png" alt="" width ="170vh" class = "img15m">
            ...
            <img src="img/definir_quadril.png" alt="" width ="170vh" class = "img16m">
            ...
            <img src="img/ombro.png" alt="" width ="135vh"  class = "img17m">
            ...
            <img src="img/treino_dorsal.png" alt="" width ="170vh" class = "img18m">
            ...
            <img src="img/treino_de_quadriceps.png" alt="" width ="135vh" class = "img19m">
            ...
            <img src="img/queimar_calorias.png" alt="" width ="135vh" class = "img20m">
            ...
            <img src="img/abdomen_lateral.png" alt="" width ="155vh" class = "img21m">
